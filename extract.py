...
for file in os.listdir("./cmdr_data"):
    if file.endswith(".txt"):
        ...
        print("Logging - Extraction Event: Found Deck List: " + file) # Replace with Logging
...
class Extract(object):
    ...
    def createDeck(self):
        ...
        with open('./cmdr_data/'+self.filename) as deck_file:
            for line in deck_file:
                ...
                with open("./cmdr_metadata/"+self.metaname,"a") as decklist:
                    fieldnames = ['Quantity','Card Name','Set','Set Release']
        ...
        print("Logging - Extraction Event: Deck Complete : " + self.deckname)
